...
TEST_P(KopilovDRunFuncTestsProcesses, RingTopologySum) { ExecuteTest(GetParam()); }

const std::array<TestType, 5> kTestParam = {
    std::make_tuple(10), std::make_tuple(0), std::make_tuple(-5), std::make_tuple(100), std::make_tuple(42)};

const auto kTestTasksList = std::tuple_cat(
    ppc::util::AddFuncTask<KopilovDRingMPI, InType>(kTestParam, PPC_SETTINGS_kopilov_d_ring_2),
