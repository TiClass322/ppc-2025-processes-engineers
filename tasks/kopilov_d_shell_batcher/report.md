...
Последовательная версия, реализованная в классе `KopilovDShellBatcherSEQ`, не является классической сортировкой Шелла всего массива. Вместо этого она имитирует структуру параллельного подхода для двух частей:
...
## 4. Детали реализации
- **`KopilovDShellBatcherSEQ`**: Последовательная реализация, описанная выше.
- **`KopilovDShellBatcherMPI`**: Параллельная реализация.
