...
class KopilovDSumValColMatPerfTests
 ...
 protected:
  ...
  bool CheckTestOutputData(OutType &output_data) override {
    if (output_data.col_sum.size() != expected_.col_sum.size()) return false;
...
const auto kAllPerfTasks =
    ppc::util::MakeAllPerfTasks<InType, KopilovDSumValColMatMPI,
...
INSTANTIATE_TEST_SUITE_P(RunModeTests, KopilovDSumValColMatPerfTests,
